//
//  PushtheStackViewController.swift
//  ScienceResearchApp
//
//  Created by Yuiko Suzuki on 7/7/21.
//

import UIKit

class PushtheStackViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
